...
if(isset($_POST["product_code"]))
{
	...
	$row=$m_san_pham->Doc_san_pham_theo_ma_san_pham($new_product['product_code']);
...
if(isset($_POST["load_cart"]) && $_POST["load_cart"]==1)
{
	...
	if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){ //if we have session variable
		...
		$cart_box .= "</ul>";
		$cart_box .= '<div class="cart-products-total">Tổng cộng : '.number_format($total,0,",",".").$currency.' <u><a href="dat-hang" title="Xem giỏ hàng">Đặt hàng</a></u></div>';
