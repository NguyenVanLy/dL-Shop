...
if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){
  ...
  <tr>
	...
	foreach($_SESSION["products"] as $product){ //Print each item, quantity and price.
		...
		$row="<tr>
				<td align='center'><img src='public/images/san_pham/".$product_image."' width='100px' height='100px'></td>
				<td>". $product_name ."</td>
				...
				<td><div class=\"shopping-cart\"><a href=\"javascript:void(0)\" class=\"remove-item\" data-code=\"$product_code\"><img src=\"public/images/close.png\" /></a></div></td>
			</tr>"; 
		$cart_box.=$row;
	...
	$cart_box.="<li><form method=\"post\" action=\"dat-hang\"><fieldset><legend><h4>Hình thức thanh toán:</h4></legend><center>";
	...
	$cart_box.="<li><center><button type=\"submit\" onclick=\"window.location='san-pham'; return false\" >Mua tiếp</button>&nbsp;&nbsp;<button type=\"submit\" value=\"end\" name=\"end\" >Đặt hàng</button></center></form></li>";
	$cart_box .= "</ul>";
	...
	/*header("refresh:3;url=san_pham.php");*/
	echo "<p><a href = 'index.php'><span class='btn glyphicon glyphicon-share-alt'> Quay về trang chủ</span></a></p>";
}
?>
